                    ...
                    <div class="col-md-12 no-padding">
                        <div class="text-center visible-lg">
                            <ul id="hornavmenu" class="nav navbar-nav">
                                ...
                                <li>
                                    <a href="new_client_registration.php" class="fa-gears">Reģistrācija</a>
                                    
                                </li>
                              <!--  <li>
                                    <a class="fa-copy">Pages</a>
                                </li>  -->  
                                
                               
                                <li>
                                    <a href="login.php" class="fa-sign-in">Ieiet</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                ...
                <div class="container background-white">
                    <div class="row margin-vert-30">
                        ...
                        <div class="col-md-6 col-md-offset-3 col-sm-offset-3">
                            <form class="signup-page" action="new_client_registration_action.php" method="POST">
                                <div class="signup-header">
                                    <h2>Reģistrācija</h2>
                                    <p>Esat reģistrējušies? Spiediet
                                        <a href="login.php"> TE </a>, lai ielogotos.</p>
                                </div>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-lg-4 text-right">
                                        <button class="btn btn-primary" type="submit" value="Register">Reģistrēties</button>
                                    </div>
                                </div>
                            </form>
                        </div>

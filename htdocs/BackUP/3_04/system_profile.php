                    ...
                    <div class="col-md-12 no-padding">
                        <div class="text-center visible-lg">
                            <ul id="hornavmenu" class="nav navbar-nav">
                                ...
                                <li>
                                    <a href="log_out.php" class="fa-sign-out">Log out</a>
                                </li>
                            </ul>
                        </div>
                    </div>
            ...
            <div id="content">
                <div class="container background-white">
                    <div class="row margin-vert-40">
                        ...
                        <!-- End Sidebar Menu -->
                        <div class="col-md-9">
                            <h2 class="margin-bottom-30">Calendar</h2>
                                    ...
                                    <div id="collapse2-One" class="accordion-body collapse in">
                                        <div class="panel-body">
                                            <div class="row">
                                                ...
                                                <div class="col-md-7">
                                                    <h3 class="no-margin no-padding">Somethings</h3>
                                                    <p>Some info if necessary</p>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
